...
from askchart.eval.m4c_evaluator import ChartQAAccuracyEvaluator
import ipdb
...
def eval_single(annotation_file, result_file):
    ...
    annotations = {(annotation['id'], annotation['text'].lower()): annotation for annotation in annotations}
    ...
    evaluator = ChartQAAccuracyEvaluator()
