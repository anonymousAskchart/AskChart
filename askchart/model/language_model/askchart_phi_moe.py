...
class MoEAskChartPhiConfig(PhiConfig):
    model_type = "moe_askchart_phi"
    ...
    def __init__(self,
        ...
        super(MoEAskChartPhiConfig, self).__init__(**kwargs)


class MoEAskChartPhiModel(LlavaMetaModel, PhiModel):
    config_class = MoEAskChartPhiConfig

    def __init__(self, config: PhiConfig):
        super(MoEAskChartPhiModel, self).__init__(config)
...
class MoEAskChartPhiForCausalLM(PhiForCausalLM, LlavaMetaForCausalLM):
    config_class = MoEAskChartPhiConfig

    def __init__(self, config):
        super(PhiForCausalLM, self).__init__(config)
        self.model = MoEAskChartPhiModel(config)
...
class EvalMoEAskChartPhiForCausalLM(MoEAskChartPhiForCausalLM):
    config_class = MoEAskChartPhiConfig

    def __init__(self, config):
        super(EvalMoEAskChartPhiForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_askchart_phi", MoEAskChartPhiConfig)
AutoModelForCausalLM.register(MoEAskChartPhiConfig, MoEAskChartPhiForCausalLM)

AutoModelForCausalLM.register(MoEAskChartPhiConfig, EvalMoEAskChartPhiForCausalLM)
