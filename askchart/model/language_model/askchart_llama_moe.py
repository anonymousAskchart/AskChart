...
class MoEAskChartLlamaConfig(LlamaConfig):
    model_type = "moe_askchart_llama"
    ...
    def __init__(self,
        ...
        super(MoEAskChartLlamaConfig, self).__init__(**kwargs)


class MoEAskChartLlamaModel(LlavaMetaModel, LlamaModel):
    config_class = MoEAskChartLlamaConfig

    def __init__(self, config: LlamaConfig):
        super(MoEAskChartLlamaModel, self).__init__(config)
...
class MoEAskChartLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    config_class = MoEAskChartLlamaConfig

    def __init__(self, config):
        super(LlamaForCausalLM, self).__init__(config)
        self.model = MoEAskChartLlamaModel(config)
...
class EvalMoEAskChartLlamaForCausalLM(MoEAskChartLlamaForCausalLM):
    config_class = MoEAskChartLlamaConfig

    def __init__(self, config):
        super(EvalMoEAskChartLlamaForCausalLM, self).__init__(config)
...
AutoConfig.register("moe_askchart_llama", MoEAskChartLlamaConfig)
AutoModelForCausalLM.register(MoEAskChartLlamaConfig, MoEAskChartLlamaForCausalLM)

AutoModelForCausalLM.register(MoEAskChartLlamaConfig, EvalMoEAskChartLlamaForCausalLM)
